...
Documentation&\cmd{ug-doc find-ugnfind-ug-doc}\\
...
\begin{tabularx}{\hsize}{lX}
& \cmd{+ - * / mod = not= < > <= >= min max and or xor round round-up round-down atan2 hypot hypot-aprox pow ring1 ring2 ring3 ring4 difsqr sumsqr sqrsum sqrdif absdif thesh amclip scale-neg clip2 excess fold2 wrap2}\\
\end{tabularx}
}
...
\verb!$Revision: 0.3.0, $Date: 13th September, 2011!\\
