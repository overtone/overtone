...
\definecolorset{hsb}{}{}
               ...
               \begin{tabularx}{\hsize}{lX}
                 Function Application & \cmd{now after-delay periodic interspaced apply-at} \\
                 OSC & \cmd{at} \\
               ...
               \colouredbox{red}{
                 ...
                 \subsection{Scope (overtone.gui.scope)}
                 \begin{tabularx}{\hsize}{lX}
               ...
               \colouredbox{orange}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   ...
                   Info & \cmd{node? node-live? node-loading? node-active? node-tree pp-node-tree}\\
               ...
               \begin{flushright}
                 ...
                 \verb!Revision: 0.8.0.0, Date: 26th January, 2013!\\
