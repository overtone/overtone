...
\definecolorset{hsb}{}{}
               ...
               {\Large{\textbf{Overtone Cheat Sheet 0.16.3331}}}

               \colouredbox{green}{
                 \section{Instruments}
                 \subsection{(use 'overtone.inst.drum)}
                 \begin{tabularx}{\hsize}{lX}
                   Kick Drums & \cmd{kick kick2 kick3 kick4 dub-kick dance-kick dry-kick quick-kick
                   %TODO round-kick
                   } \\
                   Hi-hats & \cmd{small-hat closed-hat close-hat2 open-hat hat3 soft-hat
                   %TODO noise-hat bell-hat
                   hat-demo} \\
                   Snares & \cmd{snare snare2 noise-snare tone-snare } \\
                   Percussive elements & \cmd{tom clap haziti-clap bing } \\
                 \end{tabularx}
                 \subsection{(use 'overtone.inst.piano)}
                 \begin{tabularx}{\hsize}{lX}
                   Piano & \cmd{piano}\\
                 \end{tabularx}
                 \subsection{(use 'overtone.inst.sampled-piano)}
                 \begin{tabularx}{\hsize}{lX}
                   Sampled Piano & \cmd{sampled-piano}\\
                 \end{tabularx}
                 %\subsection{(use 'overtone.inst.sampler)}
                 % TODO
                 %\begin{tabularx}{\hsize}{lX}
                 %  Sampler  & \cmd{granular}\\
                 %\end{tabularx}
                 \subsection{(use 'overtone.inst.synth)}
                 \begin{tabularx}{\hsize}{lX}
                   Synth  & \cmd{ticker ping tb303 mooger rise-fall-pad pad overpad buzz ks1 ks1-demo ks-stringer fm-demo harmonic-swimming whoahaha bubbles supersaw cs80lead simple-flute
                   %TODO b3 bowed flute
                   }\\
                   Bass  & \cmd{grunge-bass bass vintage-bass daf-bass}\\
                 \end{tabularx}
                 \subsection{(use 'overtone.inst.io)}
                 \begin{tabularx}{\hsize}{lX}
                   I/O   & \cmd{mic} \\
                 \end{tabularx}
                 ...
                 \subsection {(use 'overtone.synth.sampled-piano)}
                 \begin{tabularx}{\hsize}{lX}
                   Sampled Piano  & \cmd{sampled-piano}\\
                 \end{tabularx}
                 \subsection{(use 'overtone.synth.stringed)}
                 \begin{tabularx}{\hsize}{lX}
                   Stringed & \cmd{guitar ektara}\\
                 \end{tabularx}
                 \subsection{(use 'overtone.synth.ixi)}
                 \begin{tabularx}{\hsize}{lX}
                   Ixi  & \cmd{impulser kick kick2 kick3 snare}\\
                 \end{tabularx}
                 \subsection{(use 'overtone.synth.retro)}
                 \begin{tabularx}{\hsize}{lX}
                   Retro  & \cmd{tb-303}\\
                 \end{tabularx}
                 \subsection{(use 'overtone.synth.sts) }
                 \begin{tabularx}{\hsize}{lX}
                   STS  & \cmd{prophet}\\
                 \end{tabularx}
               ...
               \end{tabularx}
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   ...
                   Manipulate & \cmd{metro-start metro-bar-start metro-tick metro-beat metro-bpm metro-tock metro-bar metro-bpb}\\
                   bps & \cmd{beat-ms}\\
                 \end{tabularx}
               ...
               \colouredbox{red}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   ...
                   Instrument &\cmd{inst-volume! inst-pan! inst-mixer-ctl! replace-inst-mixer! replace-all-inst-mixer!}\\
                 \end{tabularx}
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   Instrument &\cmd{inst-fx! clear-fx}\\
               ...
               \colouredbox{grey}{
                 \section{Server}
                 \begin{tabularx}{\hsize}{lX}
                   Startup&\cmd{boot-server connect-server}\\
                   ...
                   Diagnostic& \cmd{server-status server-info server-opts server-connected? server-disconnected? server-connecting? connection-info server-sample-rate server-num-output-buses server-num-input-buses server-num-audio-buses server-num-buffers ensure-connected!}\\
               ...
               \colouredbox{blue}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   & \cmd{+ - * / mod = not= < > <= >= min max bit-and bit-or bit-xor round round-up round-down atan2 hypot hypot-aprox pow ring1 ring2 ring3 ring4 difsqr sumsqr sqrsum sqrdif absdif thresh amclip scale-neg clip2 excess fold2 wrap2}\\
                 \end{tabularx}
               }
               ...
               \begin{flushright}
                 ...
                 \verb!Revision: 0.16.3331.0, Date: 22nd July, 2025!\\
                 \verb!Sam Aaron (sam.aaron gmail com)!\\
                 \verb!Ambrose Bonnaire-Sergeant!
               \end{flushright}
