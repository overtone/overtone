...
\definecolorset{hsb}{}{}
               ...
               {\Large{\textbf{Overtone Cheat Sheet 0.8.0}}}

               \colouredbox{red}{
                 \section{Sounds}
                 \subsection{Instruments (overtone.inst.*)}
                 ...
                 \subsection {Synths (overtone.synth.*)}
                 \begin{tabularx}{\hsize}{lX}
                   Sampled Piano & \cmd{sampled-piano}\\
                   Stringed & \cmd{guitar}\\
               ...
               \colouredbox{orange}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   ...
                   Info & \cmd{node? node-live? node-loading? node-active? node-tree}\\
               ...
               \begin{flushright}
                 ...
                 \verb!Revision: 0.8.0.0, Date: 24th December, 2012!\\
