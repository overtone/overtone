...
\definecolorset{hsb}{}{}
               ...
               {\Large{\textbf{Overtone Cheat Sheet (Overtone 0.6.0)}}}
               ...
               \colouredbox{purple}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   ...
                   Streaming In \& Out&\cmd{buffer-stream buffer-stream? buffer-stream-close buffer-cue buffer-cue? buffer-cue-pos buffer-cue-close}\\
               ...
               \colouredbox{orange}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   ...
                   Manipulate & \cmd{node-run node-stop  node-place node-control node-control-range node-map-controls node-map-n-controls prepend-node append-node }\\
                   Info & \cmd{node-tree}\\
                 \end{tabularx}
               }
               ...
               \colouredbox{purple}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                   ...
                   Note Shifting& \cmd{shift flat sharp invert invert-chord inc-first dec-last}\\
                   Notes &\cmd{note octave-note nth-octave nth-equal-tempered-freq canonical-pitch-class-name }\\
                   Scales &\cmd{resolve-scale scale-field nth-interval resolve-degree degree->interval degrees->pitches resolve-degrees scale interval-freq}\\
                   Chords &\cmd{resolve-chord chord rand-chord}\\
               ...
               \colouredbox{red}{
                 ...
                 \begin{tabularx}{\hsize}{lX}
                    Auto cache \& Query&\cmd{freesound-info freesound-path} \\
                 \end{tabularx}
               }
               ...
               \begin{flushright}
                 ...
                 \verb!$Revision: 0.6.0.1, $Date: 20th December, 2011!\\
